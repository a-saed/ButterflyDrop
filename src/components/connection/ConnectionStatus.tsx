      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 touch-manipulation transition-all"
          >
        ...
        <PopoverContent className="w-48">
          <div className="text-sm">
            ...
            <p className="text-xs text-muted-foreground">No session active</p>
          </div>
        </PopoverContent>
      </Popover>
    );
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 relative touch-manipulation transition-all"
        >
